...
import com.central.in_books.repository.BookRepository;
...
//			body.getAuthor().contains(book.getAuthor().getId().intValue()) ||
...
//		return filteredBooks;
		List <BookResponse> books = bookRepo.getBooksCustomSearch(body.getAuthor(), body.getCategory(), body.getGenre(), body.getTheme());
//		List<Book> books = bookRepo.getBookByName("The Da Vinci Code");
		return books;
	}
